    ...
    <div class="container">
        <div class="row py-5 mt-4 align-items-center">
            ...
            <div class="col-md-6 pr-lg-5 mb-5 mb-md-0">
                ...
                <h1>Daftar</h1>
                <p class="font-italic text-muted mb-0">Daftar untuk mendapatkan berita dan promo yang menarik!</p>
            </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold">Sudah punya Akun? <a href="/login"
